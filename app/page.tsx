...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 font-sans text-white">
      <div className="flex-grow flex flex-col items-center justify-center px-6 py-20 space-y-12">
        <div className="text-center space-y-6 max-w-4xl">
          ...
          {!loading && !user && (
            <div className="flex justify-center gap-6 pt-8">
              <Link
                href="/register"
                className="px-6 py-3 bg-white text-gray-900 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition-colors duration-300"
              >
                Créer un compte
              </Link>
              <Link
